...
snowplow_sessions_with_key as (
  select distinct
    ...
    pre_trial_attribution.website_version_seen,
    ...
    lower(nvl( pre_trial_attribution.first_touch_in_source,'' ) || nvl( pre_trial_attribution.first_touch_in_medium,'' ) || nvl( pre_trial_attribution.first_touch_in_campaign,'')
          || nvl( pre_trial_attribution.first_touch_in_referer,'') || nvl( pre_trial_attribution.first_touch_landing_page,'')) as first_touch_smc_key,
    lower(nvl(pre_trial_attribution.last_touch_in_source, '') || nvl(pre_trial_attribution.last_touch_in_medium, '') || nvl(pre_trial_attribution.last_touch_in_campaign, '')
          || nvl( pre_trial_attribution.last_touch_in_referer,'') || nvl( pre_trial_attribution.last_touch_landing_page,'')) as last_touch_smc_key
...
select distinct
  ...
  first_touch_mapping.out_category as first_touch_out_category,
  ...
  last_touch_mapping.out_category as last_touch_out_category,
